...
## H2 Git - самая популярная VCS, используется разработчиками.
...
## H2 Командная строка - основной инструмент взаимодействия с компьютером.
...
## H2 Символ тильда (~) хранит ссылку на домашнюю директорию, поэтому для перехода в неё достаточно напечатать ~ и нажать Enter.
...
## H2 Сохранение файлов называется коммитом.
...
## H2 GitHub - популярная платформа для командной работы с использованием Git.
...
## H2 Git и GitHub - два независимых проекта, которые можно использовать вместе.

Другие платформы для командной работы: GitLab, Bitbucket.

---

# H1 Инструкция по регистрации на GitHub:
...
# H1 Инструкция по созданию репозитория на GitHub:
...
## H2 SSH использует пару ключей для обеспечения безопасности — публичный и приватный: 
...
### H3 Как правило, в README.md проекта можно найти следующую информацию:
...
## H2 Fork (англ. «развилка», «ответвление»), или «форк», — это GitHub-операция;
